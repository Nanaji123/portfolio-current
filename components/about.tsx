      ...
      <div className="mx-auto max-w-5xl px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-12 sm:gap-24">
          <motion.div
            ...
            viewport={{ once: true }}
            className="flex flex-col items-center gap-4 pr-10"
          >
            <h2 className="text-xl font-semibold tracking-tight text-black dark:text-white uppercase whitespace-nowrap">
              About Me
            </h2>
